...
public interface RssModuleParser {
	 ...
	 * @throws Exception
	 */
	Object parseChannel(int rssType, Document doc) throws Exception;
	 ...
	 * @throws Exception
	 */
	Object parseImage(int rssType, Document doc) throws Exception;
	 ...
	 * @throws Exception
	 */
	Object parseItem(int rssType, Document doc, int index) throws Exception;
}
